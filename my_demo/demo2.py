...
def predict_sarcasm(image_path, text):
    ...
    prompt = (
        ...
        # f'Text: {text1}'
        'I will now provide you a tweet that consists of an image and a text. Your task is to analyze the image-text pair and determine if it is sarcastic or non-sarcastic. '
